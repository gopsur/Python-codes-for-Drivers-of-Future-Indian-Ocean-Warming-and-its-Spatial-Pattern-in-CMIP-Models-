...
plt.title(f'RSST ZGRAD Mean Contribution : Annual')
plt.legend(loc='upper right')
plt.savefig('ZGRAD_mean_Contribution_Annual.eps', format='eps', dpi=500)
plt.show()
...
plt.title(f'ZGRAD diversity Contribution % wrt var(T_bar) : Annual')
plt.legend(loc='upper right')
plt.savefig('ZGRAD_diversity_Contribution_Annual.eps', format='eps', dpi=500)
