...
cont_feedback_ocean_mean_MMM = cont_feedback_ocean_mean.mean("sfc")
...
feedback_ocean_star = cont_feedback_ocean_mean - cont_feedback_ocean_mean_MMM
...
feedback_ocean_star_sqr = feedback_ocean_star * T_bar_star
...
cov_feedback_ocean_star = feedback_ocean_star_sqr.sum("sfc")/(N-1)
...
var_T_calc=(cov_rsntds_star+cov_delta_lw_a_star+cov_delta_lhf_a_star+cov_hfss_star
            +cov_Dyn_O_star+cov_feedback_ocean_star)




# covariance in percentage
...
cov_feedback_ocean_star_per = (cov_feedback_ocean_star)
